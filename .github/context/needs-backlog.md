...
| N-009 | Implement pricing feature baseline (domain, repository, screens, tests)                                                | P0       | **UI Next**  | Builder / Tester             | Dominio, repositorio y migración completos y auditados; UI y navegación siguientes.                                                                                              |
